...
using admin.Domain.Repositories.Interfaces;
using admin.Infrastructure.Data.Repositories;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("admin.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("admin.Infrastructure.Data.Repositories") &&
