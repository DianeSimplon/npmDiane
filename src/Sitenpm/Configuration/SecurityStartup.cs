...
using admin.Security.Jwt;
using admin.Domain.Services;
using admin.Domain.Services.Interfaces;
...
using AuthenticationService = admin.Domain.Services.AuthenticationService;
using IAuthenticationService = admin.Domain.Services.Interfaces.IAuthenticationService;
